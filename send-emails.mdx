...
Add your email content and include any custom variables you need to using the [Liquid](https://shopify.github.io/liquid/basics/introduction/) templating language. If you need to add any loops around data, you can use the Section element to define the content to loop through.
...
Configure your Sender Email, Sender Name, Subject Line, and Preview Text in Step 1 at the top. You can choose to override any of these values in your API call if you don't want to define them in the platform. Keep in mind you can also use Liquid variables anywhere in these fields!
...
If you have any custom Liquid variables you defined in your email, you can send a test email with these variables filled in by adding mock data to the table in Step 2.
